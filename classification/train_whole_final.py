...
def main():
    ...
    for i in range(1, 10):
        ...
        checkpoint_path = os.path.join('checkpoints',
                                        'swin_mixup_100_full_contrastive', f"run_{i+1}") 
      ...
      #  ], p=1),
       ...
       # A.OneOf([       
        ...
        train_dataset = ZooScanImageFolder(root=f"datasets/{dataset}/train", transform=train_transform, grayscale=False)
        val_dataset = ZooScanImageFolder(root=f"datasets/{dataset}/val", transform=val_transform, grayscale=False)
        ...
        checkpoint = torch.load("checkpoints/swin_contrastive_3/full_set/best_checkpoint.pth")
