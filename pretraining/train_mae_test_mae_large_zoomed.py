...
from data_utils import get_dataloader, get_default_train_transform, get_default_val_transform, get_train_transform_with_random_zoom
        ...
        for images, _ in train_dataloader:
            ...
            if step_count % steps == 0:
                ...
                if avg_val_loss < best_loss:
                    ...
                    torch.save(model.module.state_dict(), f"checkpoints_mae_large_zoomed/best_model_test_{step_count}.pth")
